...
To maintain academic integrity in this assignment, I would like to declare the use of Claude Code - the AI coding tool developed by Anthropic to overcome certain challenges as presented above. Claude was also utilised to explain concepts that I did not know and suggest solutions to code issues that I was not able to find a fix myself using other web resources.